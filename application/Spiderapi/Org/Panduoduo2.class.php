...
class Panduoduo2
{
    ...
    {
        $this->resourceModel = D('Resource2');
    ...
    {
        $currid = $this->configModel->getValue('CJUSERID2');
        if(!$currid) {
            $currid = 0;
        }
    ...
    */
    ...
    {
        try {
            $this->configModel->setValue('CJSHARTLOCK2', 1);
            $this->initUserData();
            ...
            while(true) {
                ...
                $this->configModel->setValue('CJUSERID2', $user['id']);
            ...
            $this->configModel->setValue('CJSHARTLOCK2', 2);
            ...
            if(!$this->proxyCurrRequestNum || $this->proxyCurrRequestNum > $this->proxyMaxRequestNum) {
                ...
                if(empty($proxy)) {
                    if($this->sourceType === 'user') {
                        $this->configModel->setValue('CJUSERLOCK2', 2);
