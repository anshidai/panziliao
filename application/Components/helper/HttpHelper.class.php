...
class HttpHelper
{
	...
	*/
	public static function curlGet($url, $params = array(), $timeout = 30)
	{
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, isset($params['useragent']? isset($params['useragent']: 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36');
